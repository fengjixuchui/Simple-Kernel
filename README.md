# Simple-Kernel
A minimal, cross-platform development environment for building bare-metal x86-64 programs. It is primarily designed for use with https://github.com/KNNSpeed/Simple-UEFI-Bootloader. 
