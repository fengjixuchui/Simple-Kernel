...
#set -v
#for f in $CurDir/startup/*.s; do
#  echo "$GCC_FOLDER_NAME/bin/gcc" -ffreestanding -march=skylake -mavx2 -fpie -fno-stack-protector -fno-stack-check -fno-strict-aliasing -fno-merge-all-constants -m64 -mno-red-zone -maccumulate-outgoing-args --std=gnu11 -I"$CurDir/inc/" -g -o "${f%.*}.o" "${f%.*}.s"
#  "$GCC_FOLDER_NAME/bin/gcc" -ffreestanding -march=skylake -mavx2 -fpie -fno-stack-protector -fno-stack-check -fno-strict-aliasing -fno-merge-all-constants -m64 -mno-red-zone -maccumulate-outgoing-args --std=gnu11 -I"$CurDir/inc/" -g -o "${f%.*}.o" "${f%.*}.s"
#done
#set +v
