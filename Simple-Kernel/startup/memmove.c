...
// to know "how many multiples of 512 bit (64 bytes) to move." The functions
// with byte sizes larger than their bit/8 sizes follow the same pattern:
// memmove_512bit_512B_u/a needs to know how many multiples of 512 bytes to move.
//
// The "numbytes" argument in AVX_memmove and memmove_large is just the total
...
// Yes that's a whole page. AVX-512 maxes at 2 kB stored at one time in its registers.
#endif
...
void * AVX_memmove(void *dest, void *src, size_t numbytes)
{
    ...
    ) // Check alignment
  {
    if((char *)dest < (char *)src)
    {
      ...
      memmove_large(dest, src, numbytes); // Even if numbytes is small this'll work
    }
    else // src < dest
    {
      memmove_large_reverse(dest, src, numbytes); // Need to move ends first
    }
  }
  else // Unaligned
  {
    ...
    if((char *)dest < (char *)src)
    {
      ...
      memmove_large(destoffset, srcoffset, numbytes - numbytes_to_align);
...
void * memmove_16bit(void *dest, const void *src, size_t len)
{
  ...
  const uint16_t *nexts = s + (len << 1);
  uint16_t *nextd = d + (len << 1);
...
void * memmove_32bit(void *dest, const void *src, size_t len)
{
  ...
  const uint32_t *nexts = s + (len << 2);
  uint32_t *nextd = d + (len << 2);
...
void * memmove_64bit(void *dest, const void *src, size_t len)
{
  ...
  const uint64_t *nexts = s + (len << 3);
  uint64_t *nextd = d + (len << 3);
...
void * memmove_128bit_32B_u(void *dest, const void *src, size_t len)
{
  ...
  const __m128i_u *nexts = s + (len << 5);
__m128i_u *nextd = d + (len << 5);
...
void * memmove_128bit_64B_u(void *dest, const void *src, size_t len)
{
  ...
  const __m128i_u *nexts = s + (len << 6);
  __m128i_u *nextd = d + (len << 6);
...
void * memmove_128bit_128B_u(void *dest, const void *src, size_t len)
{
  ...
  const __m128i_u *nexts = s + (len << 7);
  __m128i_u *nextd = d + (len << 7);
...
void * memmove_128bit_256B_u(void *dest, const void *src, size_t len)
{
  ...
  const __m128i_u *nexts = s + (len << 8);
  __m128i_u *nextd = d + (len << 8);
...
void * memmove_256bit_u(void *dest, const void *src, size_t len)
{
  ...
  const __m256i_u *nexts = s + (len << 5);
  __m256i_u *nextd = d + (len << 5);
...
void * memmove_256bit_64B_u(void *dest, const void *src, size_t len)
{
  ...
  const __m256i_u *nexts = s + (len << 6);
  __m256i_u *nextd = d + (len << 6);
...
void * memmove_256bit_128B_u(void *dest, const void *src, size_t len)
{
  ...
  const __m256i_u *nexts = s + (len << 7);
  __m256i_u *nextd = d + (len << 7);
...
void * memmove_256bit_256B_u(void *dest, const void *src, size_t len)
{
  ...
  const __m256i_u *nexts = s + (len << 8);
  __m256i_u *nextd = d + (len << 8);
...
void * memmove_256bit_512B_u(void *dest, const void *src, size_t len)
{
  ...
  const __m256i_u *nexts = s + (len << 9);
  __m256i_u *nextd = d + (len << 9);
...
void * memmove_512bit_128B_u(void *dest, const void *src, size_t len)
{
  ...
  const __m512i_u *nexts = s + (len << 7);
  __m512i_u *nextd = d + (len << 7);
...
void * memmove_512bit_256B_u(void *dest, const void *src, size_t len)
{
  ...
  const __m512i_u *nexts = s + (len << 8);
  __m512i_u *nextd = d + (len << 8);
...
void * memmove_512bit_512B_u(void *dest, const void *src, size_t len)
{
  ...
  const __m512i_u *nexts = s + (len << 9);
  __m512i_u *nextd = d + (len << 9);
...
void * memmove_512bit_1kB_u(void *dest, const void *src, size_t len)
{
  ...
  const __m512i_u *nexts = s + (len << 10);
  __m512i_u *nextd = d + (len << 10);
...
void * memmove_512bit_2kB_u(void *dest, const void *src, size_t len)
{
  ...
  const __m512i_u *nexts = s + (len << 11);
  __m512i_u *nextd = d + (len << 11);
...
void * memmove_512bit_4kB_u(void *dest, const void *src, size_t len)
{
  ...
  const __m512i_u *nexts = s + (len << 12);
  __m512i_u *nextd = d + (len << 12);
...
void * memmove_128bit_32B_a(void *dest, const void *src, size_t len)
{
  ...
  const __m128i *nexts = s + (len << 5);
  __m128i *nextd = d + (len << 5);
...
void * memmove_128bit_64B_a(void *dest, const void *src, size_t len)
{
  ...
  const __m128i *nexts = s + (len << 6);
  __m128i *nextd = d + (len << 6);
...
void * memmove_128bit_128B_a(void *dest, const void *src, size_t len)
{
  ...
  const __m128i *nexts = s + (len << 7);
  __m128i *nextd = d + (len << 7);
...
void * memmove_128bit_256B_a(void *dest, const void *src, size_t len)
{
  ...
  const __m128i *nexts = s + (len << 8);
  __m128i *nextd = d + (len << 8);
...
void * memmove_256bit_a(void *dest, const void *src, size_t len)
{
  ...
  const __m256i *nexts = s + (len << 5);
  __m256i *nextd = d + (len << 5);
...
void * memmove_256bit_64B_a(void *dest, const void *src, size_t len)
{
  ...
  const __m256i *nexts = s + (len << 6);
  __m256i *nextd = d + (len << 6);
...
void * memmove_256bit_128B_a(void *dest, const void *src, size_t len)
{
  ...
  const __m256i *nexts = s + (len << 7);
  __m256i *nextd = d + (len << 7);
...
void * memmove_256bit_256B_a(void *dest, const void *src, size_t len)
{
  ...
  const __m256i *nexts = s + (len << 8);
  __m256i *nextd = d + (len << 8);
...
void * memmove_256bit_512B_a(void *dest, const void *src, size_t len)
{
  ...
  const __m256i *nexts = s + (len << 9);
  __m256i *nextd = d + (len << 9);
...
void * memmove_512bit_128B_a(void *dest, const void *src, size_t len)
{
  ...
  const __m512i *nexts = s + (len << 7);
  __m512i *nextd = d + (len << 7);
...
void * memmove_512bit_256B_a(void *dest, const void *src, size_t len)
{
  ...
  const __m512i *nexts = s + (len << 8);
  __m512i *nextd = d + (len << 8);
...
void * memmove_512bit_512B_a(void *dest, const void *src, size_t len)
{
  ...
  const __m512i *nexts = s + (len << 9);
  __m512i *nextd = d + (len << 9);
...
void * memmove_512bit_1kB_a(void *dest, const void *src, size_t len)
{
  ...
  const __m512i *nexts = s + (len << 10);
  __m512i *nextd = d + (len << 10);
...
void * memmove_512bit_2kB_a(void *dest, const void *src, size_t len)
{
  ...
  const __m512i *nexts = s + (len << 11);
  __m512i *nextd = d + (len << 11);
...
void * memmove_512bit_4kB_a(void *dest, const void *src, size_t len)
{
  ...
  const __m512i *nexts = s + (len << 12);
  __m512i *nextd = d + (len << 12);
