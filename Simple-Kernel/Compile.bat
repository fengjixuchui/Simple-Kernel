...
@echo %echo_stat%
FOR /F "tokens=*" %%f IN ('type "%CurDir%\c_files_windows.txt"') DO "%GCC_FOLDER_NAME%\bin\gcc.exe" -ffreestanding -march=skylake -mtune=skylake -mavx2 -fno-stack-protector -fno-stack-check -fno-strict-aliasing -fno-merge-all-constants -mno-stack-arg-probe -m64 -mno-red-zone -maccumulate-outgoing-args --std=gnu11 -I!HFILES! -Og -g3 -Wall -Wextra -Wdouble-promotion -fmessage-length=0 -ffunction-sections -c -MMD -MP -Wa,-adhln="%%~df%%~pf%%~nf.out" -MF"%%~df%%~pf%%~nf.d" -MT"%%~df%%~pf%%~nf.o" -o "%%~df%%~pf%%~nf.o" "%%~ff"
@echo off
...
@echo %echo_stat%
FOR %%f IN ("%CurDir2%/startup/*.c") DO "%GCC_FOLDER_NAME%\bin\gcc.exe" -ffreestanding -march=skylake -mtune=skylake -mavx2 -fno-stack-protector -fno-stack-check -fno-strict-aliasing -fno-merge-all-constants -mno-stack-arg-probe -m64 -mno-red-zone -maccumulate-outgoing-args --std=gnu11 -I!HFILES! -Og -g3 -Wall -Wextra -Wdouble-promotion -fmessage-length=0 -ffunction-sections -c -MMD -MP -Wa,-adhln="%CurDir2%/startup/%%~nf.out" -MF"%CurDir2%/startup/%%~nf.d" -MT"%CurDir2%/startup/%%~nf.o" -o "%CurDir2%/startup/%%~nf.o" "%CurDir2%/startup/%%~nf.c"
@echo off
...
@echo %echo_stat%
FOR %%f IN ("%CurDir2%/startup/*.s") DO "%GCC_FOLDER_NAME%\bin\gcc.exe" -ffreestanding -march=skylake -mtune=skylake -mavx2 -fno-stack-protector -fno-stack-check -fno-strict-aliasing -fno-merge-all-constants -mno-stack-arg-probe -m64 -mno-red-zone -maccumulate-outgoing-args --std=gnu11 -I"%CurDir2%/inc/" -g -o "%CurDir2%/startup/%%~nf.o" "%CurDir2%/startup/%%~nf.s"
@echo off
...
@echo on
FOR %%f IN ("%CurDir2%/src/*.c") DO "%GCC_FOLDER_NAME%\bin\gcc.exe" -ffreestanding -march=skylake -mtune=skylake -mavx2 -fno-stack-protector -fno-stack-check -fno-strict-aliasing -fno-merge-all-constants -mno-stack-arg-probe -m64 -mno-red-zone -maccumulate-outgoing-args --std=gnu11 -I!HFILES! -Og -g3 -Wall -Wextra -Wdouble-promotion -fmessage-length=0 -ffunction-sections -c -MMD -MP -Wa,-adhln="%CurDir2%/src/%%~nf.out" -MF"%CurDir2%/src/%%~nf.d" -MT"%CurDir2%/src/%%~nf.o" -o "%CurDir2%/src/%%~nf.o" "%CurDir2%/src/%%~nf.c"
@echo off
...
rem "%GCC_FOLDER_NAME%\bin\gcc.exe" -march=skylake -mtune=skylake -mavx2 -s -T%LinkerScript% -nostdlib -Wl,-e,kernel_main -Wl,--subsystem,10 -Wl,-Map=output.map -Wl,--gc-sections -o "Kernel64.exe" @"objects.list"
@echo on
"%GCC_FOLDER_NAME%\bin\gcc.exe" -march=skylake -mtune=skylake -mavx2 -s -nostdlib -Wl,-e,kernel_main -Wl,--subsystem,10 -Wl,-Map=output.map -Wl,--gc-sections -o "Kernel64.exe" @"objects.list"
@echo off
